...
// =========================================
// CO-MSE/stan-R-compare/src/LCMCR_2.stan
// borrowed from CO-MSE/stan-explorations/src/cap_recap_LCM_one_year.stan
//
// Enforcing the ordering on the proportion sizes
...
transformed parameters {
  ...
  for (i in 1:K) {
    lambda_T[i] = col(lambda, sort_indices_desc(pi)[i])';
  }
  
  pi = pi[sort_indices_desc(pi)];
